    ...
    <div>
      ...
      <div className="icons-container">
        ...
        <div className="ui-patterns">
          ...
          <p>
            <Link to="/uipattern">UI Patterns</Link>
          </p>
        </div>
        <div className="forms">
          <div className="icon">
      ...
      <div className="main">
        <div className="main-container">
          ...
          <div className="first-container">
            ...
            <ul>
              ...
              <li>
                ...
                passwords and raise the barrier for attackers tampering with
                your system.
              </li>
              <li>
          ...
          <div className="fourth-container">
            <h1>What is a strong password?</h1>
            <p>
          ...
          <div className="sixth-container">
            <h1>Choosing an appropriate level of password strength</h1>
            <p>
          ...
          <div className="seventh-container">
            <h1>General guidelines on choosing a password</h1>
            <ul>
              <li>
          ...
          <div className="eighth-container">
            ...
            <p>
              <ul>
                <li>
                  By showing a password strength meter beside the password
                  field, the user is forced to consider using a password with an
                  appropriate strength. By putting a minimum level of password
                  strength you can even use the password strength meter to force
                  a heightened security to your website.
                </li>
                <li>
                  Using a password strength indicator on the website, adds
                  another level of security is added to the site. This not only
                  makes the current users of the site feel more secure, but
                  potential clients might use this as a requisite when deciding
                  to conduct business with a company.
                </li>
              </ul>
            </p>
          </div>
