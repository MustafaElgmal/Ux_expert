    ...
    <div >
      ...
      <header  className="bg-[#0085F7] w-full flex flex-row justify-between px-[4%]  py-[1%]">
        <div className="text-[#FFFFFF] pt-[0.5%] flex flex-row gap-6 ">
          <button className="flex flex-row gap-4 font-semibold opacity-80 hover:opacity-100">
            <svg
          ...
          <button className="opacity-80 hover:opacity-100">
            ...
            >
              <path
                d="M43.4799 19.2301H17.4799V9.7301C17.4802 9.33491 17.3634 8.94849 17.1443 8.6196C16.9252 8.29072 16.6136 8.03412 16.2487 7.8822C15.8839 7.73028 15.4823 7.68985 15.0945 7.766C14.7067 7.84216 14.3502 8.03149 14.0699 8.3101L2.58989 19.8201C2.21738 20.1948 2.0083 20.7017 2.0083 21.2301C2.0083 21.7585 2.21738 22.2654 2.58989 22.6401L14.0899 34.1501C14.3702 34.4287 14.7267 34.618 15.1145 34.6942C15.5023 34.7704 15.9039 34.7299 16.2687 34.578C16.6336 34.4261 16.9452 34.1695 17.1643 33.8406C17.3834 33.5117 17.5002 33.1253 17.4999 32.7301V23.2301H43.4999C62.7599 24.0301 62.7599 51.4801 43.4999 52.2301H33.3399C32.8095 52.2301 32.3007 52.4408 31.9257 52.8159C31.5506 53.191 31.3399 53.6997 31.3399 54.2301C31.3399 54.7605 31.5506 55.2692 31.9257 55.6443C32.3007 56.0194 32.8095 56.2301 33.3399 56.2301H43.4799C68.0499 55.2601 67.9999 20.2401 43.4799 19.2301Z"
                fill="white"
              />
            </svg>
          </button>
          <button className="opacity-80 hover:opacity-100">
            ...
            >
              <path
                d="M61.4099 19.82L49.9099 8.31005C49.6898 8.09236 49.4222 7.92872 49.1282 7.83202C48.8341 7.73532 48.5216 7.7082 48.2153 7.75279C47.909 7.79738 47.6172 7.91247 47.3629 8.08899C47.1086 8.26551 46.8988 8.49865 46.7499 8.77005C46.574 9.07317 46.4874 9.41982 46.4999 9.77005V19.27H20.4999C-4.07008 20.27 -4.06008 55.27 20.4999 56.27H30.6599C31.1904 56.27 31.6991 56.0593 32.0741 55.6843C32.4492 55.3092 32.6599 54.8005 32.6599 54.27C32.6599 53.7396 32.4492 53.2309 32.0741 52.8558C31.6991 52.4808 31.1904 52.27 30.6599 52.27H20.5199C1.25992 51.48 1.25992 24.02 20.5199 23.27H46.5199V32.77C46.5196 33.1652 46.6364 33.5517 46.8555 33.8805C47.0746 34.2094 47.3862 34.466 47.7511 34.6179C48.1159 34.7699 48.5176 34.8103 48.9053 34.7341C49.2931 34.658 49.6496 34.4687 49.9299 34.19L61.4299 22.68C61.6191 22.4925 61.7689 22.269 61.8705 22.0227C61.9722 21.7764 62.0236 21.5123 62.0217 21.2458C62.0198 20.9794 61.9648 20.716 61.8597 20.4712C61.7546 20.2264 61.6017 20.005 61.4099 19.82Z"
                fill="white"
              />
            </svg>
          </button>
        ...
        <button onClick={toggleShow}  className="export-design bg-[#FFFFFFF2]   rounded-lg flex flex-row gap-3 px-[3%] py-[0.5%] font-medium text-[16px]  hover:shadow-xl hover:border-x-1">
          <svg
            className="bottom-1"
            xmlns="http://www.w3.org/2000/svg"
            width="20"
      ...
      <div className="flex flex-row">
        ...
        <svg className="pl-[1%]"
            ...
            <input className=" ml-[1%] block w-full"
              type="text"
      ...
      >
        <SwiperSlide>
          <button  className=" px-[5%] py-[5%] border-[1px] border-[#FFFFFFB2] opacity-70 text-[14px] text-center hover:opacity-100"> login Screen</button>
        </SwiperSlide>
        <SwiperSlide>
          <button  className=" px-[5%] py-[5%] border-[1px] border-[#FFFFFFB2] opacity-70 text-[14px] text-center hover:opacity-100"> login Screen</button>
        </SwiperSlide>
        ...
        <div className="my-[3%] box">
          <div className="text-[#FFFFFFE5] font-semibold text-left">Recently used</div>
         
          <div className=" px-[1%] text-left text-[#FFFFFFB2] my-[2%]" id="item" draggable={true} >
                  <img src={Login} /> 
...
                  <img src={Login} /> 
    ...
    {show&&<div className="w-[40%] z-50   absolute top-[40%] left-[30%]" >
        ...
        <div className="rounded-lg text-[#0085F7] text-center text-2xl py-[5%]  bg-white font-medium">Great!  Your Design <br/> is created successfully</div>
        <div className="bg-white flex flex-row justify-around text-center text-sm text-white px-[2%]">
          <button className="bg-[#0085F7] w-[20%] rounded-sm " onClick={saveToFileHtml}><i class="fa fa-download" aria-hidden="true"></i> Html</button>
          <button className="bg-[#0085F7] w-[20%] rounded-sm" onClick={()=>saveToFileReact(loginpage)}><i class="fa fa-download" aria-hidden="true"></i> React</button>
          <button className="bg-[#0085F7] w-[20%] rounded-sm" onClick={saveToFileVue}><i class="fa fa-download" aria-hidden="true"></i>  Vue.js</button>
        </div>
        <div className="rounded-lg bg-white py-[5%]"><button className="hover:text-[#0085F7]">return back to home page</button> </div>
      </div>}
    </div>
    </div>
  );
