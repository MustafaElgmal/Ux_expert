  ...
  return (
    <div className="my-[2%] mx-[10%]">
      <div className="flex flex-row justify-between text-left">
        <div>
          <div className="text-left mb-[3%] font-bold text-3xl">Trending Color Palettes</div>
          <div className="font-medium">Get inspired by thousands of beautiful color</div>
          <div className="font-medium">schemes and make something cool!</div>
        </div>
        <button  className="font-semibold hover:text-[#0085F7]">Want to Extract Color<br/>Palette from Your Logo?</button>
      </div>
    ...
    {pallets.map((pallet) => (
        ...
        }} className="text-center text-[24px] font-normal border-2 rounded-[10px] bg-[#FFFFFF] px-[10%] w-[60%] shadow-md hover:bg-[#0085F7] hover:text-white mt-[100px]" >
              see more palettes
          </button>
    </div>
  );
